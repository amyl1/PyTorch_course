# -*- coding: utf-8 -*-
"""1.1_2_Two-Dimensional_Tensors_v2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QF2nZbkyi2XirW_X-RXIzUSbBoyR3tJG
...
new_tensor2 = torch.tensor(df.values)
print(new_tensor2)
...
x = torch.tensor([[0, 2, 1, 1], [1, 2, 0, 1]])
y = torch.tensor([[1, 1], [1, 1], [-1, 1],[2,2]])
xy = torch.mm(X,Y)
print(xy)
