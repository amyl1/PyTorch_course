...
Original file is located at
    https://colab.research.google.com/drive/1EOpNEwsKTXY7yrquM1OMLFI40LVNzM2c
...
class my_add_mult(object):
    ...
    # Constructor
    def __init__(self, addx = 4, muly = 3):
        self.addx = addx
        self.muly = muly
...
compose = transforms.Compose([mult(), add_mult()])
my_transformed_dataset = toy_set(transform = compose)
for i in range(3):
